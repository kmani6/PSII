function [sqerror, dsqerror] = calc_sqerror_simple_model_O2_per_PSII(x,... Set of parameters. This only includes the independent variables as described by the third column in Y and Constants files
